...
class __TwigTemplate_3f2bc603441f829f02d8f4bcf74d90b9a0b669adaaed8440b587dec3d4dda10d extends \Twig\Template
{
    ...
    {
        return new Source("", "{# inline_template_start #}{{ description }}{% if not supported %}<div><small>{% trans %}<strong>Not available</strong>. You may need to install external dependencies for use this plugin.{% endtrans %}</small></div>{% endif %}", "");
    }
}
